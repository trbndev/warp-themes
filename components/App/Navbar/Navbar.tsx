...
function AppNavbar() {
  ...
  return (
    <nav className='flex w-full py-3 pl-4 pr-2 fixed items-center bg-white border-b flex-row justify-between'>
      ...
      <Link href='/sale'>
        <div className='bg-purple-500/20 py-2 px-4 rounded-full border-purple-700 border-2'>
          💰 Warp-Themes & Warp-Companion are for sale! <span className='font-bold'>→ Learn more.</span> 💰
        </div>
      </Link>
        ...
        <Popover>
          ...
          >
            ...
            >
              ...
              <li>
                <a href='https://github.com/haackt/warp-companion' target='_blank' rel='noopener noreferrer' className='text-sm'>
