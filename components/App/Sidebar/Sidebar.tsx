...
function AppSidebar() {
  ...
  return (
    <div className='px-4 pt-20 h-full overflow-y-scroll w-fit bg-base-100 text-base-content z-40'>
      ...
      <div className='prose prose-zinc border-t py-4'>
        <h4>⚠️ Important information</h4>
        <p>
          If no buyer is found until the 16th August 2023, this project will only be available via the URL{' '}
          <a href='https://warp-themes.vercel.app'>https://warp-themes.vercel.app</a>
        </p>
      </div>
    </div>
  );
