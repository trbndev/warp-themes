  ...
  return (
    <>
      <Head>
        ...
        <meta property='og:description' content='With Warp-Themes you can easily create themes for the Warp Terminal ✨' />
        <meta property='og:image' content='https://raw.githubusercontent.com/haackt/warp-themes/main/.github/assets/hero.png' />
        ...
        <meta property='twitter:description' content='With Warp-Themes you can easily create themes for the Warp Terminal ✨' />
        <meta property='twitter:image' content='https://raw.githubusercontent.com/haackt/warp-themes/main/.github/assets/hero.png' />
